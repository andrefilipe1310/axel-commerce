    ...
    return (
        <>
            <div onClick={() => useStore.toogleCart()} className="flex items-center cursor-pointer relative">
                ...
                <span className="bg-teal-600 text-sm font-bold rounded-full h-5 w-5 flex items-center justify-center absolute left-3 bottom-3">3</span>
            
            </div>
            {!useStore.isOpen && (<CartDraw/>)}
